...
CATEGORIES = {
    "1": ("general", "📈 General Recommendations"),
    "2": ("domain_specific", "🔍 Domain-Specific Recommendations"),
    "3": ("interactive", "📚 Interactive Recommendations"),
    "4": ("evaluation", "🎮 System Evaluation"),
    "5": ("single_agent", "🤖 Single-Agent Systems"),
    "6": ("multi_agent", "👥 Multi-Agent Systems"),
}
...
def print_banner():
    ...
    print("=" * 70)
    print("  📝 Add/Edit Paper - Agent4Rec Survey")
    print("=" * 70)
    print()
...
def run_update_scripts():
    ...
    try:
        ...
        print("  ⚠️ Warning: render_papers.py not found or failed")
    ...
    try:
        ...
        print("  ⚠️ Warning: sync_readme.py not found or failed")
